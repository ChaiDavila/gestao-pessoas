...
export function AsoFilters({ opcoes }: { opcoes: OpcoesFormulario }) {
    ...
    <div className="flex flex-wrap items-end gap-3">
      ...
      <div className="w-64 space-y-1">
        ...
        <NativeSelect
          ...
          onChange={(e) => atualizarFiltro("situacao", e.target.value)}
        >
          <option value="">Situação: todas</option>
          <option value="pendente">Com pendência (a vencer/vencido/nunca feito)</option>
          <option value="valido">Tudo em dia</option>
        </NativeSelect>
      </div>
    </div>
  );
