...
// reconstruir quem estava ativo em datas passadas (headcount histórico). Não confundir
// com getDesligamentos(), que respeita os filtros da tela e é usado pra contar quem entra
// no numerador de cada indicador.
